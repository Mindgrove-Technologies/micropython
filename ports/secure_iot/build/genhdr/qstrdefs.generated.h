...
QDEF1(MP_QSTR____builtins__, 26952, 13, "___builtins__")
...
QDEF1(MP_QSTR___builtins__, 34871, 12, "__builtins__")
...
QDEF1(MP_QSTR_bit_rate, 64167, 8, "bit_rate")
...
QDEF1(MP_QSTR_crandom, 16701, 7, "crandom")
...
QDEF1(MP_QSTR_default_len, 4150, 11, "default_len")
QDEF1(MP_QSTR_default_mode, 35570, 12, "default_mode")
...
QDEF1(MP_QSTR_lsb_first, 43005, 9, "lsb_first")
QDEF1(MP_QSTR_machine, 43872, 7, "machine")
QDEF1(MP_QSTR_master_mode, 50213, 11, "master_mode")
...
QDEF1(MP_QSTR_mymodule, 51275, 8, "mymodule")
QDEF1(MP_QSTR_myvar, 5844, 5, "myvar")
...
QDEF1(MP_QSTR_null, 51678, 4, "null")
...
QDEF1(MP_QSTR_prescalar, 5548, 9, "prescalar")
...
QDEF1(MP_QSTR_recieve, 54734, 7, "recieve")
...
QDEF1(MP_QSTR_rx_thresh, 32384, 9, "rx_thresh")
...
QDEF1(MP_QSTR_spi_id, 63709, 6, "spi_id")
...
QDEF1(MP_QSTR_testfunc, 557, 8, "testfunc")
...
QDEF1(MP_QSTR_uart_print, 7417, 10, "uart_print")
QDEF1(MP_QSTR_uint16, 18564, 6, "uint16")
QDEF1(MP_QSTR_uint8, 64123, 5, "uint8")
QDEF1(MP_QSTR_ulab, 21151, 4, "ulab")
QDEF1(MP_QSTR_ulab_dot_numpy, 51679, 14, "ulab_dot_numpy")
QDEF1(MP_QSTR_ulab_dot_numpy_dot_fft, 42100, 22, "ulab_dot_numpy_dot_fft")
QDEF1(MP_QSTR_ulab_dot_numpy_dot_linalg, 17409, 25, "ulab_dot_numpy_dot_linalg")
QDEF1(MP_QSTR_ulab_dot_numpy_dot_random, 63675, 25, "ulab_dot_numpy_dot_random")
QDEF1(MP_QSTR_ulab_dot_scipy, 35024, 14, "ulab_dot_scipy")
QDEF1(MP_QSTR_ulab_dot_scipy_dot_integrate, 14300, 28, "ulab_dot_scipy_dot_integrate")
QDEF1(MP_QSTR_ulab_dot_scipy_dot_linalg, 18030, 25, "ulab_dot_scipy_dot_linalg")
QDEF1(MP_QSTR_ulab_dot_scipy_dot_optimize, 31094, 27, "ulab_dot_scipy_dot_optimize")
QDEF1(MP_QSTR_ulab_dot_scipy_dot_signal, 43345, 25, "ulab_dot_scipy_dot_signal")
QDEF1(MP_QSTR_ulab_dot_scipy_dot_special, 38638, 26, "ulab_dot_scipy_dot_special")
